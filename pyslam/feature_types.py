...
class FeatureDetectorTypes(Enum):   
    ...
    GLAM        = 25  # Similar to SIFT, COMP6411B
...
class FeatureDescriptorTypes(Enum):
    ...
    GLAM        = 30  # Similar to SIFT, COMP6411B
...
class FeatureInfo(object): 
    ...
    #
    norm_type[FeatureDescriptorTypes.GLAM] = cv2.NORM_L2
    max_descriptor_distance[FeatureDescriptorTypes.GLAM] = 5            # GLAMpoints  
    #
